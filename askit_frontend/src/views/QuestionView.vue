...
<!--        <h1 class="text-3xl font-bold ">{{ title }}</h1>-->
        <br>
<!--        <p class="mb-2">{{ explanation }},{{ author }}, {{ module }}, {{ tried_what }}, {{ summary }}, {{ pub_date }},-->
<!--          {{ status }}, {{ score }}, {{ views }}, {{ upvote_or_downvote }}, {{ tags }}</p>-->

      </div>
      <div class="p-4">
<!--        <p class="mb-4">{{ author }}, {{ module }}, {{ explanation }}, {{ tried_what }}, {{ summary }}, {{ pub_date }},-->
<!--          {{ status }}, {{ score }}, {{ views }}, {{ upvote_or_downvote }}, {{ tags }}</p>-->
        <form action="submit_answer/" method="post" class="mt-4">
<!--          {% csrf_token %}-->
