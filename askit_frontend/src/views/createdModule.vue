<template>
  <div>
    <div class="mb-6">
    <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Module name</label>
...
export default {
  ...
  methods: {
    addModule() {
      axiosClient.post(`/new/module/${this.$route.params.mod}/`, {
