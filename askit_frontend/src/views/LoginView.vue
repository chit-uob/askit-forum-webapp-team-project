  ...
  <div class="bg-gray-100 min-h-screen flex flex-col justify-center items-center">
    <div class="flex items-center flex-wrap mb-8">
      ...
      <form @submit.prevent="submitForm" class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <div>
          <label class="text-black"> Don't have an account? </label><button v-on:click="redirectToSignUp" class="text-blue-400 hover:underline hover:text-blue-500">Sign up!</button>
        </div>
      </form>
