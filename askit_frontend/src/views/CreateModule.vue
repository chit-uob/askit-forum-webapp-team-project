  ...
  <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none crypto_bg">
    <div class="py-6">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <h1 class="block mb-2 text-3xl font-semibold text-gray-900 dark:text-white">Create Course</h1>
      </div>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="mb-6">
          <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Course
            Name</label>
          <input type="text" id="default-input" v-model="moduleTitle"
                 class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Course description</label>
