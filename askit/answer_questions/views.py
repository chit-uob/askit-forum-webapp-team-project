...
def set_up_test_database(request):
    ...
    ossp = Module(title="OSSP", description="An Operating System is the system software that manages computer hardware, hardware and software resources and provides common services for user programs. System programming is the type of programming necessary to produce software, such as operating systems, that deal with hardware, provide services to other software or manage performance constraints. This module teaches the technology of operating systems and introduces students to the challenges of systems-level programming .Also, this module gives practical insight into modern operating system topics. ")
    ossp.save()
    tp = Module(title="TP", description="This module teahes about team project, which is a capstone project for the students to apply the knowledge they have learned in the past 3 years. ")
    tp.save()
    sn = Module(title="SN", description="This moduel teaches about security and networking. It covers the basic concepts of computer security and networking. It also covers the design and implementation of secure systems and networks. ")
    sn.save()
