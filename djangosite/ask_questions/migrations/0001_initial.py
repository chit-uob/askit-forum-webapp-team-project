    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ask_questions.module')),
                ('tags', models.ManyToManyField(related_name='question_tags', to='ask_questions.tag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ask_questions.question')),
